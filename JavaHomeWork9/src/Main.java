public class Main {
    public static void main(String[] args) {
        ...
        for (int g = 0; g < reverseFullName.length / 2; g++) {
            char swap = reverseFullName[g];
            reverseFullName[g] = reverseFullName[reverseFullName.length - 1 - g];
            reverseFullName[reverseFullName.length - 1 - g] = swap;
        }
